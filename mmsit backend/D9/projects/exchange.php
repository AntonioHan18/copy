    ...
    <form action="./exchange-process.php" method="post">
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <div class="col-span-full">
                ...
                <label for="input-label" class="block text-sm font-medium mb-2 dark:text-white">From Currency Exchange</label>
                <input type="amount" id="input-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
