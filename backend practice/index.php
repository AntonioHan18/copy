        ...
        <section class="bg-gray-100 p-10 rounded-lg ">
            ...
            <form action="./area.php" method="post">
                <div class="mb-4">
                    ...
                    <input type="number" name="home_width" id="input-label" class="mb-4 py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                </div>

                <div class="mb-6">
                    <label for="home_breadth" class=" block text-sm font-medium mb-2 dark:text-white">Home breadth</label>
                    <input type="number" name="home_breadth" id="input-label" class="mb-4 py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                </div>

                <div class="flex gap-3">

                <button type="submit" name="calc_btn" class="flex-grow justify-center  py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                    Calculate
                </button>


                <a href="/record-list.php" name="calc_btn" class="flex-grow justify-center  py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                    All Record 
                <a>
