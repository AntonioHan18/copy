...
if (empty($_POST["home_width"])  || empty($_POST["home_width"]))  {
    // die("need all input");
...
<body>
    ...
    <main class="max-w-[1000px] mx-auto p-10">
        ...
        <section class="bg-gray-100 p-10 rounded-lg ">
            ...
            <a href="./index.php" type="button" class="w-full my-4 justify-center py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                Calculate Again 
            </a>
